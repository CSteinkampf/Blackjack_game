...
class Play_game:
    ...
    def player_win(self, hand_select):
        self.player.chips += (hand_select * 2)
        self.dealer.table_earnings -= (hand_select * 2)
        hand_select = 0

    def dealer_win(self, hand_select):
        self.dealer.table_earnings += hand_select
        hand_select = 0
    
    def draw(self, hand_select):
        self.player.chips += hand_select
        hand_select = 0
